...
func TestAxolotlV1NormalizationMatchesCanonicalByteShape(t *testing.T) {
	m := manifest.Manifest{
		...
		Packets: []manifest.Packet{{ID: 7, Name: "Fixture", Direction: manifest.DirectionUnknown, Fields: []manifest.Field{
...
func TestAxolotlParityRejectsProtocolMix(t *testing.T) {
	m := manifest.Manifest{SchemaVersion: 2, Target: manifest.Target{MinecraftVersion: "1.26.40", ProtocolVersion: 2168}, Sources: []manifest.SourcePin{{ID: "fixture", Kind: "synthetic", Revision: "fixture", Digest: "fixture:parity", MinecraftVersion: "1.26.40", ProtocolVersion: 2168}}, Packets: []manifest.Packet{{ID: 1, Name: "P", Direction: manifest.DirectionUnknown, Fields: []manifest.Field{{Ordinal: 0, Name: "Value", Encode: manifest.Primitive("u8"), Symmetry: manifest.Symmetric, Provenance: manifest.Provenance{Pins: []string{"fixture"}}}}}}}
	path := filepath.Join(t.TempDir(), "axolotl.json")
