...
func DefaultPacketSpecs() []PacketSpec {
	return []PacketSpec{
		...
		{ID: packet.IDResourcePacksInfo, Name: "ResourcePacksInfoPacket", File: "resource_packs_info.dat"},
		{ID: packet.IDResourcePackStack, Name: "ResourcePackStackPacket", File: "resource_pack_stack.dat"},
		{ID: packet.IDResourcePackDataInfo, Name: "ResourcePackDataInfoPacket", File: "resource_pack_data_info.dat", Optional: true},
