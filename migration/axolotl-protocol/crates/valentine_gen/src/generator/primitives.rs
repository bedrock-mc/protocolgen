...
pub fn primitive_to_unsigned_tokens(p: &Primitive) -> TokenStream {
    match p {
        ...
        Primitive::U16 => quote! { u16 },
        Primitive::I16 => quote! { u16 },
        Primitive::U32 => quote! { u32 },
        Primitive::I32 | Primitive::VarInt | Primitive::ZigZag32 => quote! { u32 },
        Primitive::U64 => quote! { u64 },
        Primitive::I64 | Primitive::VarLong | Primitive::ZigZag64 => quote! { u64 },
        _ => quote! { u64 },
    }
}
...
pub fn primitive_to_enum_repr_tokens(p: &Primitive) -> TokenStream {
    match p {
        ...
        Primitive::I16 => quote! { i16 },
        Primitive::U32 => quote! { u32 },
        Primitive::I32 | Primitive::VarInt | Primitive::ZigZag32 => quote! { i32 },
        Primitive::U64 => quote! { u64 },
        Primitive::I64 | Primitive::VarLong | Primitive::ZigZag64 => quote! { i64 },
        _ => quote! { i32 },
    }
}
