...
function canonicalPrimitive(op, field) {
  ...
  if (op === "RawBytes" && /Serialised(?:Offers|InventoryData|EntityIdentifiers|EventData)$/.test(field ?? "")) return "Nbt";
  return canonical(op);
}
