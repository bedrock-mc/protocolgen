...
type SetDisplayObjective struct {
	// DisplaySlotName is the slot in which the scoreboard should be displayed. Available options can be found in
	// the constants above.
	DisplaySlotName string
	// ObjectiveName is the name of the objective that the scoreboard displays. Filling out a random unique value
	...
	// CriteriaName is the name of the criteria that need to be fulfilled in order for the score to be increased.
	// This can be any kind of string and does not show up client-side.
	CriteriaName string
	// SortOrder is the order in which entries on the scoreboard should be sorted. It is one of the constants that
	// may be found above.
	SortOrder int32
}
