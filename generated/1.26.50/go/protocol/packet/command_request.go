...
type CommandRequest struct {
	// Command is the raw entered command line. The client does no parsing of the command line by itself (unlike
	// it did in the early stages), but lets the server do that.
	Command string
