...
type UpdateClientInputLocks struct {
	// Locks is a set of flags that specify which client inputs are disabled, such as whether the player
	// can move, rotate the camera, jump, sneak or mount/dismount entities. It is a combination of the
