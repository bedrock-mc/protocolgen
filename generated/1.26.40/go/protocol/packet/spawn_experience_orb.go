...
type SpawnExperienceOrb struct {
	...
	Position mgl32.Vec3
	// XPValue is the amount of experience in experience points that the orb carries. The client-side size of the
	// orb depends on the amount of experience in the orb: There are 11 possible sizes for the orb, for 1–2,
	// 3–6, 7–16, 17–36, 37–72, 73–148, 149–306, 307–616, 617–1236, 1237–2476, and 2477 and up.
	XPValue int32
}
