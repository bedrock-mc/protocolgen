...
// reference an "anonymous group" which has an empty name OR no icon. The order of Groups and Items is how the
// client will render items in the creative inventory compared to the previous, hard coded order.
...
// "planks" group {CreativeItemNetworkID: 4, Item: protocol.ItemStack{...}, GroupIndex: 2}, // Ungrouped after
// "planks" {CreativeItemNetworkID: 5, Item: protocol.ItemStack{...}, GroupIndex: 2}, // Ungrouped after
// "planks" } }
